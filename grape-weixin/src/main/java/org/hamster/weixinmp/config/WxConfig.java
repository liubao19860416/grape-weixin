...
public class WxConfig {
    ...
    //用户基本信息配置
    // @Value("#{wxProperties3.usernotlogin}")
    ...
    //菜单基本信息配置
    @Value("#{wxProperties.wx_menu_create_url}")
    private String menuCreateUrl;
    @Value("#{wxProperties.wx_menu_get_url}")
    ...
    @Value("#{wxProperties.wx_custom_send_url}")
    private String customSendUrl;

    @Value("#{wxProperties.wx_media_upload_url}")
    private String mediaUploadUrl;

    @Value("#{wxProperties.wx_qrcode_create_url}")
    private String qrcodeCreateUrl;

    @Value("#{wxProperties.wx_user_info_url}")
    private String userInfoUrl;
    @Value("#{wxProperties.wx_user_get_url}")
    private String userGetUrl;

    @Value("#{wxProperties.wx_groups_create_url}")
    private String groupsCreateUrl;
    @Value("#{wxProperties.wx_groups_get_url}")
    private String groupsGetUrl;
    @Value("#{wxProperties.wx_groups_getid_url}")
    private String groupsGetIdUrl;
    @Value("#{wxProperties.wx_groups_update_url}")
    private String groupsUpdateUrl;
    @Value("#{wxProperties.wx_groups_members_update_url}")
