...
<body>
	<h1>文件上传页面</h1>
	<form id="excelForm" action="<%=request.getContextPath()%>/basic/upload.htm" method="post" enctype="multipart/form-data" >
		<input type="file" name="fileName" id="fileName">
		<input type="submit" name="submitBtn" value="点击提交">
		<input type="button" name="fileUploadBtn" value="点击导入">
	</form>
</body>
