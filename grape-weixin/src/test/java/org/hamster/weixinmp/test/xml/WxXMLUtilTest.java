...
public class WxXMLUtilTest {
    ...
    public static final String MSG_TEXT_XML = "<xml>"
            ...
            + "<Content><![CDATA[this is a test from LIUBAO]]></Content>"
            + "<MsgId>1234567890123456</MsgId>" + "</xml>";

    @Test
    public void testGetMsgText() throws DocumentException {
        WxMsgTextEntity msgText = WxXmlUtil.getMsgText(WxXmlUtil
                .toXML(MSG_TEXT_XML));
        assertBaseFieldsWithMsgId(msgText);
        Assert.assertEquals("this is a test from LIUBAO", msgText.getContent());
    }
    ...
    public void testGetMsgImg() throws DocumentException {
        WxMsgImageEntity msgImg = WxXmlUtil.getMsgImage(WxXmlUtil
                .toXML(MSG_IMG_XML));
    ...
    public void testGetMsgLoc() throws DocumentException {
        WxMsgLocEntity msgLoc = WxXmlUtil.getMsgLoc(WxXmlUtil
                .toXML(MSG_LOC_XML));
    ...
    public void testGetMsgLink() throws DocumentException {
        WxMsgLinkEntity msgLink = WxXmlUtil.getMsgLink(WxXmlUtil
                .toXML(MSG_LINK_XML));
    ...
    public void testGetMsgEvent() throws DocumentException {
        WxMsgEventEntity msgEvent = WxXmlUtil.getMsgEvent(WxXmlUtil
                .toXML(MSG_EVENT_XML));
